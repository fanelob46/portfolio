function MyPortfolio(){
    return <div className="MyPortfolio">
        ...
        <div className="skills">
            <h1>My Skills</h1>
            <p>Technologies i am working with recently</p>
            <div className="skills-icon">
               <div className="hmtl-icon">
        ...
        <div className="projects">
            ...
            <div className="card">
                ...
                <div className="card-content">
                    <h1>Buy and rent books online</h1>
                    <div>
                      <p>System to book and rent books online for a library</p>
                    </div>
            ...
            <div className="card">
                ...
                <div className="card-content">
                    <h1>Survey </h1>
                    <div>
                    <p>System to take Surveys on people's lifestyle</p>
                    </div>
                    <button>View Github</button>
                </div>
            </div>
