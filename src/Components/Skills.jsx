...
const Skills = () => {
  return (
    <div className="bg-[#201c24]">
      <h1 className="text-9xl text-white pb-20">My skills</h1>
      <div className="grid grid-cols-2  place-items-center space-y-10">
        {/* Javascript*/}
        <div className="flex bg-slate-900 text-white w-[720px] ">
          <div>
            <IoLogoJavascript className="text-yellow-400 text-[150px]" />
          </div>
          <div className="space-y-10 ">
            <h1 className="text-5xl">JAVASCRIPT</h1>
            <p className="text-5xl text-gray-600">programming language</p>
          </div>
        </div>
        {/* Express js*/}
        <div className="flex bg-slate-900 text-white w-[720px] ">
          <div>
            <SiExpress className="text-gray-400 text-[150px]" />
          </div>
          <div className="space-y-10 ">
            <h1 className="text-5xl">Express js</h1>
            <p className="text-5xl text-gray-600"> Web Framework</p>
          </div>
        </div>
        <div className="flex bg-slate-900 text-white w-[720px] ">
          <div>
            <RiTailwindCssFill className="text-blue-200 text-[150px]" />
          </div>
          <div className="space-y-10">
            <h1 className="text-5xl">TailwindCss</h1>
            <p className="text-5xl text-gray-600"> Css Framework</p>
          </div>
        </div>
        <div className="flex bg-slate-900 text-white w-[720px] ">
          <div>
            <FaReact className="text-blue-400 text-[150px]" />
          </div>
          <div className="space-y-10">
            <h1 className="text-5xl">React js</h1>
            <p className="text-5xl text-gray-600"> JavaScript Library</p>
          </div>
        </div>
        <div className="flex bg-slate-900 text-white w-[720px] ">
          <div>
            <SiMongodb className="text-green-500 text-[150px]" />
          </div>
          <div className="space-y-10">
            <h1 className="text-5xl">Mongo Db</h1>
            <p className="text-5xl text-gray-600"> Database</p>
          </div>
        </div>
        <div className="flex bg-slate-900 text-white w-[720px] ">
          <div>
            <SiTypescript className="text-blue-700 text-[150px]" />
          </div>
          <div className="space-y-10">
    ...
    // <div className='bg-[#201c24] ] h-100vh pt-36 md:pt-72 lg:pt-[500px]' id='skills'>
    //     <h1 className='text-white sm:text-3xl kobus:text-8xl text-2xl text-center pb-5'>Skills</h1>

    //     <div className='text-white grid grid-cols-1 py-4  pc:grid-cols-2 border-2  px-5 lg:px-20 sm:text-3xl   kobus:space-x-20 kobus:px-20 kobus:py-20 pc:space-x-20  '>
    //         <div className='shadow-white border-2  kobus:px-20 kobus:py-20  '>
    //             <h1 className='text-center kobus:text-5xl pt-3'>Front-end</h1>
    //             <div className='grid  grid-cols-2 kobus:grid-cols-2 pc:grid-cols-2 place-items-center py-10 space-y-2 text-center  '>
    //             <div className=''>
    //             <FaHtml5 className='text-orange-600 sm:text-6xl kobus:text-8xl text-2xl' />
    //             <h1>HTML5</h1>
    //             </div>
    //             <div>
    //             <FaCss3Alt className='text-blue-800  kobus:text-8xl text-2xl sm:text-6xl '/>
    //             <h1>CSS3 <span className='text-[#201c24]'>rrrrrrrrr</span></h1>
    //             </div>
    //             <div>
    //             <RiTailwindCssFill className='text-blue-200 kobus:text-8xl text-2xl sm:text-6xl'/>
    //             <h1>TAILWIND</h1>
    //             </div>
    //             <div>
    //             <IoLogoJavascript className='text-yellow-400 kobus:text-8xl text-2xl sm:text-6xl'/>
    //             <h1>JAVASCRIPT</h1>
    //             </div>
    //             <div>
    //             <FaReact className='text-blue-400 kobus:text-8xl text-2xl sm:text-6xl'  />
    //             <h1>REACTJS</h1>
    //             </div>
    //             <div>

    //             <FaBootstrap className='text-blue-300 kobus:text-8xl text-2xl sm:text-6xl'/>
    //             <h1>BOOTSTRAP</h1>
    //             </div>

    //             </div>
    //         </div>
    //         <div className='shadow-white border-2  kobus:px-20 kobus:py-20  m-0'>
    //             <h1 className='text-center kobus:text-5xl pt-3 pc:py-10'>Back-end</h1>
    //             <div className='grid grid-cols-2 place-items-center py-10 space-y-2 text-center'>
    //                 <div className=' place-items-center'>
    //                 <BiLogoSpringBoot
    //                 className='text-green-500 kobus:text-8xl text-3xl sm:text-6xl' />
    //                 <h1>SPRINGBOOT</h1>
    //                 </div>
    //             <div>
    //             <DiMysql className='text-blue-800 kobus:text-8xl text-2xl sm:text-6xl'/>
    //             <h1>MYSQL</h1>
    //             </div>
    //             <div>
    //             <FaJava className='text-yellow-400 kobus:text-8xl text-2xl sm:text-6xl'/>
    //             <h1>JAVA</h1>
    //             </div>
